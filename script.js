...
,"Panthera Arctos": {
    ...
    TagsCriatura: "Animal,Taiga,Savana,Caça em Grupo,Comunidade,@Damn",
    TipoElementoCriatura: "Caos",
...
cnxTest: 17,
  ...
  bonus: `
Resistente: Poder, Medo
Vulnerável: Fé, Desconhecido, Queda
Imune: Caos
`,
...
{pigmento}*Dilúvio Anômalo – teste de Brutalidade:*{/pigmento}
Nuvens se condensam instantaneamente, liberando uma chuva sobrenatural de sapos venenosos e granizo, causando _5d12 de dano de Tempestade_ e aplicando **Envenenado**.

{pigmento}*Cólera do Céu – teste de Brutalidade:*{/pigmento}
Trovoadas descem violentamente do firmamento, causando _7d10 de dano de Tempestade_ em linha de 30m.

{pigmento}*Mergulho dos Vendavais – habilidade de Montaria:*{/pigmento}
Montado em Hrasvelg, Orvednir atravessa os céus em alta velocidade, causando _5d12 de dano de Tempestade_ em todos os inimigos atravessados.
`,
...
`,
  ...
  Magias: `
Sabe todas as magias do domínio da Tempestade.
`,

  Passivas: `
Sabe todas as passivas do domínio da Tempestade.
Imunidade a efeitos de deslocamento forçado causados por vento.
`,
...
,
  ...
  img: "imagens/Orvednir.png",
  img2: "imagens/Token-Orvednir.png"
}
...
Elas apenas esperam o momento de renascer.`,
  ...
  ,"Vespa-Cogumelo": {
    ...
    "especialPorNivel": 3,
    "armaduraPorNivel": 3,
    TagsCriatura: "Ácido,Caça em Grupo,Agressivo,Voador,Comunidade,@Tio_lipe",
    TipoElementoCriatura: "Caos",
...
"Verme Fúngico": {
  ...
  especialPorNivel: 5,
  armaduraPorNivel: 3,
    TagsCriatura: "Agressivo,Floresta,Ácido,Comunidade,@Tio_lipe",
    TipoElementoCriatura: "Caos",
  bru: 10,
  agi: 10,
  det: 20,
...
Nível 3 – Cogumelos Tóxicos`,
  ...
  ,"Rastejadores": {
    ...
    especialPorNivel: 5,
    armaduraPorNivel: 1,
    TagsCriatura: "Agressivo,Morte,Humanoide,Comunidade,@Tio_lipe",
    TipoElementoCriatura: "Fé",
...
Se são reais ou não, pouco importa. Seu nome já basta para silenciar conversas em corredores escuros.`,
  ...
  "Donzela branca": {
    ...
    especialPorNivel: 5,
    armaduraPorNivel: 3,
    TagsCriatura: "Pacífico,Sagrado,Ilha do Céu,Comunidade,@Tio_lipe",
    TipoElementoCriatura: "Fé",
...
Elemento – o elemento Fé`,
 ...
 _imgs: [
  ...
  TagsCriatura: "Cidade,Racional,Animal,Comunidade,@H1five",
  TipoElementoCriatura: "Caos",
  bonus: `Resistente: Caos  
...
Sua inteligência vai além da de um felino comum, sendo capazes de compreender ordens complexas e até usar pequenas magias instintivamente. Quando ameaçados, revelam uma forma caótica e aterradora, que muitos acreditam ser sua verdadeira natureza mágica.`,
  ...
  armaduraPorNivel: 5,
movimento: 7,
    TagsCriatura: "Névoa,Rohan,Aberração,Raro,Comunidade,@Tio_lipe",
 TipoElementoCriatura: "Desconhecido",
...
"The book": {
  ...
  armaduraPorNivel: 2,
  movimento:7,
    TagsCriatura: "Sanidade,Raro,Item,Comunidade,@Tio_lipe",
 TipoElementoCriatura: "Poder", 
...
armaduraPorNivel: 5,
movimento: 8,
TagsCriatura: "Fiskehavn,Oceano,Luz,Comunidade,@Tio_lipe",
TipoElementoCriatura: "Fé",
...
img2: "imagens/Token-OctoRedsel Abissal.png"}
  ...
  TagsCriatura: "Água,Tempestade,Lendário, Comunidade,@Damn",
  TipoElementoCriatura: "Caos",
...
,"Kharuun": {
  ...
  TagsCriatura: "Gelo,Tremor,Lendário,Comunidade,@Damn",
  TipoElementoCriatura: "Caos",
